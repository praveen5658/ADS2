...
public final class Solution {
    ...
    public static void main(final String[] args) {
        ...
        case "ViaPaths":
            ...
            // First is the source and second is
            // the via is the one where path should
            // pass throuh.
            ...
            int cou = 0;
            DijkstraAllPairsSP dijkstraallpairs = new
            DijkstraAllPairsSP(graph);
            if (dijkstraallpairs.hasPath(from, to)) {
                System.out.println(dijkstraallpairs.dist(
                    from, via) + dijkstraallpairs.dist(via, to));
